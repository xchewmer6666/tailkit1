                    ...
                    <div className="inline-block w-full mt-5 sm:mt-8">
                        <div className="flex items-start space-x-4 md:items-center">
                            <div className="inline-block rounded-md shadow">
                                <Link href="/started">
                                    <div className="flex items-center justify-center w-full px-4 px-8 py-2 py-3 text-base font-medium text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                                        Get started
                                    </div>
                                </Link>
                            </div>
